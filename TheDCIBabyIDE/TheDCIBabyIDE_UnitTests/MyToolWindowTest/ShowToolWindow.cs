...
using KimHaiQuang.TheDCIBabyIDE;

namespace TheDCIBabyIDE_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new BabyIDEPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(BabyIDEPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
